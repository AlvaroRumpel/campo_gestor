...
class _PiquetesScreenState extends ConsumerState<PiquetesScreen> {
        ...
        Expanded(
          child: _showLots
              ...
              : PiquetesBoardView(
                  ...
                  canEdit: canEdit,
                  onOpenPaddock: (p) => context.go('/piquetes/${p.id}'),
                  onEditPaddock: (p) => _openForm(context, paddock: p),
                  onDeletePaddock: (p) => _confirmDelete(context, p),
                ),
        ),
        if (selected != null)
          LoteDetailPanel(
  ...
  Future<void> _openForm(BuildContext context, {Paddock? paddock}) =>
      editPaddock(context, ref, paddock: paddock);
