...
class _PiquetesScreenState extends ConsumerState<PiquetesScreen> {
  ...
  static String _blockedMessage(int lotCount) => Intl.plural(
        lotCount,
  ...
  Future<void> _confirmDelete(BuildContext context, Paddock paddock) async {
    ...
    // item 1). O trigger trg_paddocks_archive_guard bloqueia no banco; aqui
    // a UI explica antes de o usuário confirmar.
