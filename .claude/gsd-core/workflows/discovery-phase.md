...
See F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/discovery.md
...
Use F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/discovery.md.
