...
<template>
@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/workflows/transition.md`.
...
- Follow @F:/_geral/Projetos/campo_gestor/.claude/gsd-core/workflows/diagnose-issues.md
