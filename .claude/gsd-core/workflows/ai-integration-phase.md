...
<required_reading>
@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/ai-frameworks.md
@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read F:/_geral/Projetos/campo_gestor/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read F:/_geral/Projetos/campo_gestor/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read F:/_geral/Projetos/campo_gestor/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read F:/_geral/Projetos/campo_gestor/.claude/agents/gsd-eval-planner.md for instructions.
