...
```markdown
Read F:/_geral/Projetos/campo_gestor/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/_geral/Projetos/campo_gestor/.claude/agents/gsd-ui-checker.md for instructions.
...
@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / F:/_geral/Projetos/campo_gestor/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "F:/_geral/Projetos/campo_gestor/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "F:/_geral/Projetos/campo_gestor/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
