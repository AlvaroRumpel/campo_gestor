...
```
Agent(
  prompt="Read F:/_geral/Projetos/campo_gestor/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/SECURITY.md`
