...
<!-- For checkpoint task examples and patterns, see @F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/checkpoints.md -->
...
See `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
