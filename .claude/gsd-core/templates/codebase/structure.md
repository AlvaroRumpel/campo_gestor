...
- Usage: Reference from command with `@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to F:/_geral/Projetos/campo_gestor/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to F:/_geral/Projetos/campo_gestor/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
