...
Use template from `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/UI-SPEC.md`
