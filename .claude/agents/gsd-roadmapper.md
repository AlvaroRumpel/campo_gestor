...
Reference full template: `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/_geral/Projetos/campo_gestor/.claude/gsd-core/templates/state.md`.
