...
<required_reading>
@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = F:/_geral/Projetos/campo_gestor/.claude
                  → checks F:/_geral/Projetos/campo_gestor/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/_geral/Projetos/campo_gestor/.claude/gsd-core
                  → writes to F:/_geral/Projetos/campo_gestor/.claude/gsd-core/hooks/
...
@F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @F:/_geral/Projetos/campo_gestor/.claude/gsd-core/references/common-bug-patterns.md
